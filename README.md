...
**Enumerable** is a simple program that Creates and imports a module that you can use in your Ruby projects..
...
```
  git clone https://github.com/H-Ramalan/Enumerable.git
  cd Enumerable
```
...
- Twitter: [@hamza_ramalan](https://twitter.com/myro_dev)
- LinkedIn: [Hamza Ramalan](https://linkedin.com/in/kimitawanjohi)
